...
//			
	...
	@Produces(MediaType.APPLICATION_JSON)
	@Path ("{id}")
	public void updatearticle(@PathParam("id")int id)
	{article a=gestiontrocRemote.findArticleById(id);
	 gestiontrocRemote.updatearticle(a);
	...
	{
		article a=gestiontrocRemote.findArticleById(id);
		gestiontrocRemote.deletearticle(a);
